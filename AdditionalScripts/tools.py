...
class CulebrONT(object):
    ...
    def __init__(self, workflow, config, culebront_path):
        ...
        self.tools_config = load_configfile(culebront_path.joinpath("tools_path.yaml"))
        ...
        try:
            validate(self.config, culebront_path.joinpath("schemas/config.schema.yaml").resolve().as_posix())
        except Exception as e:
            raise ValueError(
