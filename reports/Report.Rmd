...
```
**CulebrONT in a Snakemake workflow available on [github](https://github.com/SouthGreenPlatform/CulebrONT_pipeline) created by:**

J. Orjuela (IRD), A. Comte (IRD), Bao Tram Vi (IRD), S. Ravel (CIRAD), F. Charriat (CIRAD), F. Sabot (IRD) and S. Cunnac (IRD),
...
for (i in 1:length(fichiers)) {
   ...
   data <- read.csv(paste0(fichiers[i],"/Stats_benchmark.csv"),
                      header = FALSE,
                      sep=",",
                      dec =".")
